...
final incomeSummaryProvider =
    StateNotifierProvider<SalesNotifier, AsyncValue<FinancialSummary>>(
  ...
  Future<void> setAllProviders() async {
    try {
      await Future.wait([
        ...
        ref.read(extraPayProvider.notifier).setAllExtraPays(),
      ]);
