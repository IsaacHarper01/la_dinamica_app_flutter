...
class RegisterGymWidget extends ConsumerStatefulWidget {

  const RegisterGymWidget({super.key});

  @override
  ConsumerState<RegisterGymWidget> createState() => _RegisterGymWidgetState();
}

class _RegisterGymWidgetState extends ConsumerState<RegisterGymWidget> {
            ...
            children: [
              ...
              Row(children: [
                ...
                FilledButton(onPressed: ()async{
                  ref.read(userProvider.notifier).registerGym(gymNameController.text, sportController.text, userModel!.user);
