...
class EarnScreenState extends ConsumerState<EarnScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return incomeState.when(
      ...
      data: (data) {
        return Scaffold(
          body: incomeScreen(context, screenWidth, data, date, user, months),
          ...
          child: Column(
            ...
            children: [
              ...
              BoxInfoWidget(
                ...
                extraData: incomeData.extraPays.totalDay,
              ...
              BoxInfoWidget(
                ...
                extraData: incomeData.extraPays.totalRange,
                expenses: incomeData.expenses.totalRange,
                date: date,
                text:
                    "Ingresos mensuales: ${months[DateTime.parse(date).month]}",
              ),
              const SizedBox(height: 20),
              Container(
                width: screenWidth,
