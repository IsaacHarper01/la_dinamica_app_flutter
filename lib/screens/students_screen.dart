...
class StudentsScreenState extends ConsumerState<StudentsScreen>
  ...
  Future<void> _deleteAttendance(Attendance attendance) async {
    ...
    await ref
        ...
        .deleteAttendance(attendance, ref.read(dateProvider).today);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: studentsFuture.when(
        error:
            (e, s) =>
                Center(child: Text("Error al obtener la lista de Alumnos")),
        ...
        data: (students) {
          return Column(
            children: [
              ...
              StudentsNumberHome(
                studentsNumber: "Total de alumnos: ${students.length}",
              ),
                      ...
                      FilledButton.icon(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (builder) => AddStudentScreen(),
                            ),
                          );
                        },
                        label: const Text(
                                  ...
                                  if (direction ==
                                    ...
                                    if (attendance.isNotEmpty) {
                                      ...
                                      ScaffoldMessenger.of(
                                        ...
                                        const SnackBar(
                                          content: Text(
                                            'Este alumno no tiene asistencia registrada',
                                          ),
                                        ),
                                      );
                                    }
