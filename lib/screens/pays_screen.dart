...
class _PaysScreenState extends ConsumerState<PaysScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final screenWidth =
        MediaQuery.of(context).size.width * (isPortrait ? 1 : 0.8);
      ...
      body: FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final names = data[0] as List<String>;
            final ids = data[1] as List<String>;
            final plansType = data[2] as List<String>;
            final costs = data[3] as List<String>;
            final clases = data[4] as List<String>; // Añadir las clases
                                ...
                                builder: (context, nameIndex, _) {
                                  return DropdownButtonFormField<String>(
                                    ...
                                    onChanged: (String? newValue) {
                                      if (newValue != null) {
                                        nameIndexNotifier.value = names.indexOf(
                                          newValue,
                                        );
                                      }
                                    },
                              ...
                              ValueListenableBuilder<int>(
                                ...
                                builder: (context, planIndex, _) {
                                  return DropdownButtonFormField<String>(
                                    ...
                                    onChanged: (String? newValue) {
                                      if (newValue != null) {
                                        planIndexNotifier.value = plansType
                                            .indexOf(newValue);
                                      }
                                    },
                                    items:
                                        plansType.map<DropdownMenuItem<String>>(
                                          (String value) {
                                            return DropdownMenuItem<String>(
                                              value: value,
                                              child: Text(
